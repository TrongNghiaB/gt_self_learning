...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/Waterfall-Regular.ttf
  String get waterfallRegular => 'assets/fonts/Waterfall-Regular.ttf';
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/gg logo.jpg
  AssetGenImage get ggLogo => const AssetGenImage('assets/images/gg logo.jpg');

  /// List of all assets
  List<AssetGenImage> get values => [ggLogo];
}
